...
export async function ensureAuthToken(): Promise<string> {
  ...
  try {
    ...
    console.error('Failed to establish authenticated session:', err);
    throw new Error('Unable to authenticate with OpsOS backend. Ensure backend is running on port 8000.');
  }
}
